...
export default function ProjectCard({ project }: Props) {
  ...
  return (
    <div className={`shadow border bg-white dark:border-0 dark:bg-gray-800 rounded p-4 w-full sm:basis-1/2-gap-4 lg:basis-1/3-gap-4 xl:basis-1/4-gap-4 flex flex-col gap-2 relative cursor-pointer`}
